    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        private void OnCollisionEnter(Collision other)
        {
            ...
            for (int i = 0; i < other.contacts.Length; i++)
                n += other.contacts[i].normal;
            
            OnHandleCollsion?.Invoke(n.normalized, other.relativeVelocity);
        }
        
        public delegate void HandleCollision(Vector3 normal, Vector3 relVel);
        public event HandleCollision OnHandleCollsion;
